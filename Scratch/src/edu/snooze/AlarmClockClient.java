...
class AlarmClockClient {
    ...
    public static void main(String[] args) {
        ...
        AlarmClock clock2 = new AlarmClock(); // if you place the 10 in the () on this line, then get rid of next
        clock2.setSnoozeInterval(10); // <-- This one
        ...
        // show their toString() methods in actions
